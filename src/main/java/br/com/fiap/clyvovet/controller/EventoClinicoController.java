...
public class EventoClinicoController {
    ...
    @GetMapping
    public ResponseEntity<List<EventoClinicoResponse>> listarTodos() {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EventoClinicoResponse> atualizar(@PathVariable UUID id, @Valid @RequestBody EventoClinicoRequest request) {
